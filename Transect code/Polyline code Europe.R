...
LGM_dataset <-merge(LGM_dataset, ent20, by ='ID_ENTITY')




LGM_datasetaus <-LGM_dataset %>% filter(lat < -25.5 & lat >-40, lon <153.5 &lon > 135.5)
LGM_datasetaus <-LGM_datasetaus %>% filter(ID_ENTITY != 2205) ##ANggi has really low values
